    ...
    <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
      ...
      <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
        ...
        <div class="flex justify-between">
          ...
          <div class="">
            <p class="mb-1 text-lg font-bold">{{Cart::getTotal()}}€</p>
        ...
        <form action="/session" method="POST">
            ...
            <input type="hidden" name="productname" value="{{Cart::getContent()}}">
            <button href="{{route('test.index')}}" class="mt-6 w-full rounded-md bg-blue-500 py-1.5 font-medium text-blue-50 hover:bg-blue-600">Check out</button>
