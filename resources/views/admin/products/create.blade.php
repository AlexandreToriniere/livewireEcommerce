<x-admin-layout>
    ...
    <div class="py-12">
        <div class="flex  m-2 p-2">
            <a href="{{ route('admin.products.index')}}" class=" px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">products index</a>
        </div>
                  ...
                  <div class="sm:col-span-6">
                    ...
                    <div class="mt-3">
                      ...
                      <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <select multiple id="categories" name="categories[]" class="form-multiselect block w-full mt-1 @error('categories') border-red-400 @enderror">
