            ...
            <form method="POST" action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data">
                ...
                @method('PUT')
                  <div class="sm:col-span-6">
                    ...
                    <div class="mt-1">
                        <input type="text" id="slug"  name="slug" value="{{$product->slug}}" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                    </div>
                    <label for="quantity" class="block text-sm font-medium text-gray-700">Quantity </label>
                    <div class="mt-1">
                        <input type="number" id="quantity" value="{{$product->quantity}}" name="quantity" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                    </div>
                    <div>
                    ...
                    <div class="mt-1">
                        <input type="text" id="meta_title" value="{{$product->meta_title}}" name="meta_title" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                    </div>

                    <label for="meta_key" class="block text-sm font-medium text-gray-700"> Meta_keyword</label>
                    <div class="mt-1">
                        <input type="text" id="meta_key"  name="meta_key" value="{{$product->meta_key}}"class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                    </div>

                    <label for="meta_description" class="block text-sm font-medium text-gray-700">Meta_description</label>
                    <div class="mt-1">
                      <textarea id="meta_description" rows="3" name="meta_description" class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border  rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('description') border-red-400 @enderror"> {{$product->meta_description}}</textarea>
                    </div>
