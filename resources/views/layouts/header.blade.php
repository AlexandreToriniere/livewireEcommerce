      ...
      <nav class="flex justify-between bg-gray-900 text-white w-screen">
        <div class="px-5 xl:px-12 py-6 flex w-full items-center">
          ...
          <ul class="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
            {{-- <li><a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="{{route('welcome')}}">Acceuil</a></li> --}}
          ...
          <div class="hidden xl:flex items-center space-x-5 items-center">
            ...
            {{-- <a class="flex items-center hover:text-gray-200" href="{{route('register.index')}}">
                <svg xmlns="http://www.w3.org/1000/svg" class="h-6 w-6 hover:text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
            </a> --}}
